...
<body>
    <div class="min-h-full">
        ...
        <nav class="bg-azul-tec">
            <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
                ...
                <span class="text-white">
                    ...
                    <div class="mx-auto max-w-7xl py-4 px-4 sm:px-20 lg:mr-96 ">
                    ...
                    <div class="relative ml-3" x-data="{ open: false }">
                        ...
                        <div id="profileDiv"
                            ...
                            <a href="#" class="block px-4 py-2 text-sm text-gray-700" role="menuitem"
                                tabindex="-1" id="user-menu-item-1">Herramientas</a>
        ...
        <main class="flex bg-gray-100">
            <aside class="sidebar bg-azul-tec relative h-screen w-72 md:w-65 hidden sm:block shadow-xl h-auto left-[-400px] peer:transition ease-out delay-150 duration-200">
                ...
                <nav class="text-white text-base font-semibold pt-3">
                    ...
                    <div class="text-left text-sm mt-2 w-4/5 mx-auto text-gray-200 font-bold" id="submenu">
                        <h1 onClick="location.href='/registro'"
                            class="cursor-pointer p-2 hover:bg-sky-600 rounded-md mt-1">
                            Proyecto
                        </h1>
            ...
            <div id="sidemDiv" class="fixed top-20 w-full h-screen overflow-y-hidden absolute">
                ...
                <header class="bg-azul-tec w-full py-5 px-6 sm:hidden">
                    ...
                    <nav class="text-white text-base font-semibold pt-3">
                        ...
                        <a class="block text-white opacity-75 hover:opacity-100 py-4 pl-6 nav-item"
                            onclick="dropdown()">
                            <i class="bi bi-chat-left-text-fill"></i>
                            <div class="flex justify-between w-full items-center">
            ...
            <!-- formulario -->
            <div class="px-4 py-6 w-full h-full lg:flex flex-col">

                <div class="h-20 w-3/4">
                    <h1 class="pt-6 lg:pl-32 font-bold text-3xl md:text-left">Registro de la actividad</h1>
                </div>


                <div class="lg:flex flex-row h-3/6 w-full mt-3 justify-center sm:flex flex-wrap sm: flex justify-center ">
                    <div class="w-72 h-full">
                    <form>
                        <div class="mb-5 mt-7 mr-10">
                            <input id="nombreAct" name="nombreAct" type="text" placeholder="Nombre de la actividad"
                            ...
                            <input id="departamentoAct" name="departamentoAct" type="text"
                                ...
                                class="p-3 w-full h-16 rounded-md border mt-7 border-black shadow-md" />
                ...
                <div class="h-full w-3/4 mt-3 mx-32 lg:grid grid-cols-3 gap-10 sm:flex flex-wrap bg-red-500">
                    <div class="col-span-2 h-full">
                        <input id="descripcion" name="descripcion" type="text" placeholder="Descripción"
                        class="h-32 w-full rounded-md border border-black shadow-md" />
                    </div>
                    <div class="col-span-1">
                        <button type="submit" value="Registrar Actividad" class="bg-sky-600 hover:bg-sky-700 rounded-md px-20 py-5 text-white font-bold text-lg">
                            Registrar</button>
                    </div>
                </div>
            </div>
