...
@section('content')
      <div class="flex justify-center">  
        <div class="flex justify-center mt-10 h-auto w-auto md:w-1/2 lg:w-2/6  bg-white shadow-xl rounded-md mb-10">
            <div class="m-12">
                ...
                <div class="mt-4">
                <form method="POST">
                <label for="correoA" class="font-sans text-gray-500">Correo:</label>
                <input id="correoA" name="correoA" type="text"
