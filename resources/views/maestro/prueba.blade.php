...
-->
 <!-- Sidebar -->
    <div class="bg-azul-tec h-screen fixed">
        <div class="bg-azul-tec h-screen w-20">
            <div class="sidebar h-screen ml-7 w-[3.30rem] overflow-hidden hover:w-56 hover:bg-azul-tec ">
                <div class="flex flex-col justify-between pt-2 pb-6 mt-20">
                       <div class="w-max pl-3">
                     ...
                     <ul class="mt-6 space-y-2 tracking-wide">
                       ...
                       <li class="min-w-max">
                           <a href="/tAct"
                               ...
                               <span class="text-[15px] text-lg ml-4 text-gray-200 font-bold">Actividades</span>
                           </a>
                       </li>
    ...
    <div class="flex flex-col h-screen w-full">
        <nav class="bg-azul-tec pl-18">
            <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
                ...
                <div class="relative flex items-center justify-between h-20">
                        ...
                        <form method="GET" class="w-full invisible sm:visible">
                            <div class="relative text-gray-500 ml-6 px-3 pt-5">
                                <span class="absolute inset-y-0 left-0 flex items-center pl-2">
                                    ...
                                    <input type="search"
                                        class="text-md text-white w-full rounded-md pl-10 bg-transparent placeholder-white focus:outline-none focus:bg-sky-800 focus:text-"
                                        placeholder="Buscar">
                                    </div>
                                </span>
                            </div>
                    ...
                    <div class="mx-auto max-w-7xl py-4 px-8 mr-10 lg:mr-96">
        ...
        <div class="flex-grow pl-24">
            <div class="px-4 py-6  lg:flex flex-col">

                <div class="h-20 w-3/4">
                    <h1 class="pt-6 lg:pl-64 font-bold text-3xl md:text-left">Registro de la actividad</h1>
                </div>
                ...
                <div class="lg:flex flex-row h-3/6 w-full mt-3 justify-center sm:flex flex-wrap">
                    ...
                    <div class="w-72 h-full sm:mt-4 lg:mt-0 lg:ml-3">
                        ...
                        <div class="mb-5 lg:mt-7 mr-10 sm:mt-2">
                            <input id="totalA" name="totalA" type="number" min="1"
                                ...
                                <textarea id="description"
                                    class="p-2 mt-7 text-sm text-gray-900 rounded-lg border border-black focus:border-blue-500 h-60 w-60"
